...
public class cutScene extends JPanel {
    ...
    public cutScene(WeebChronicles m){
        mainFrame = m;
        frame = 0;
        fCount1 = 0;
        fCount2 = 0;
        ...
        suprised = new ImageIcon("Ryan Funyanjiwan/hit8.png").getImage();
        ...
        plat = new ImageIcon("Pictures/doorPlat.png").getImage();
        door = new ImageIcon("Pictures/door.png").getImage();
        road = new Image[5];
    ...
    public void paintComponent(Graphics g){
        ...
        if(frame > 6375){
            g.setColor(Color.white);
            g.setFont(weebFont);
            g.drawString("TO BE CONTINUED", 50,305);
        }
        if(frame > 6575){
            watched = true;
        }
